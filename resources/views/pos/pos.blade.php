        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <label class="text-danger">Categorias :</label>
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{ $data->price }} MZN</td>
                            <td>{{ $data->qty * $data->price }} MZN</td>
                    ...
                    <!-- Order Total -->
                        <tr>
                            <td colspan="3" class="text-right font-weight-bold">Total de Vendas = </td>
                            <td>{{ Cart::subtotal() }} MZN</td>
                            <td></td>
                        </tr>
                    </table>
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="{{ url('/add-cart') }}" method="POST">
                            ...
                            <td>
                                <button type="submit" class="btn btn-success btn-xs"><i class="fa fa-plus"> adicionar</i></button>
                            </td>
                        </form>
                        </tr>
